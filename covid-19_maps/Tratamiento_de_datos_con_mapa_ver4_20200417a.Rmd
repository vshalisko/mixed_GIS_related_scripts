---
title: "Tratamiento datos COVID-19 México 17/04/2020"
...
datos <- read.csv("200417COVID19MEXICO.csv")
datos_ayer <- read.csv("200416COVID19MEXICO.csv")
...
datos_defunciones <- datos[datos$RESULTADO == 1 & datos$FECHA_DEF != '',]
...
plot(npen$casos, npen$pruebas, 
     col = "blue", pch = 1, cex = 2, #xaxt='n',
     ylab = "No. de pruebas", xlab = "No. de casos confirmados",
...
# Relación entre número de casos confirmados y numero de pruebas por municipios de México

```{r fig.width = 10, fig.height = 8, echo = FALSE}
par(mfcol=c(1,1))
e <- 2.71828182846

plot(cpmn$casos, cpmn$negativos + cpmn$casos, 
